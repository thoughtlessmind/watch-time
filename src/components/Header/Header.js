  ...
  return (
    <nav className='bg-gray-800 py-4 md:px-12 sm:px-4 px-2 shadow fixed w-screen top-0 left-0 z-50'>
      ...
      <div className='grid grid-cols-12 gap-2 md:gap-4'>
        <p className='text-white text-xl md:text-2xl md:col-span-3 col-span-4 cursor-pointer'>
          Watch Time
        </p>
        <input
        ...
        />
        <div className='col-span-2 lg:col-span-5 px-3 col-start-11 col-end-12 md:col-start-12 '>
